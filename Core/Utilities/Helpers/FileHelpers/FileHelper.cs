...
namespace Core.Utilities.Helpers.FileHelpers
{
    ...
    {
        private static string _currentDirectory = Environment.CurrentDirectory + "\\wwwroot\\images\\";
        private static string _folderName="";

        public static IResult Upload(IFormFile file)
        {
            var fileExits = CheckFileExists(file);
            if (fileExits.Message != null)
            {
                return new ErrorResult(fileExits.Message);
            }
